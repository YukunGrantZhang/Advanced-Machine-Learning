...
def beta(h_number_minus, graph):
    ...
    summation_beta = summation_beta + get_probability(1, graph, h_number_minus + 1, 1, h_number_minus + 1, 2) * get_probability(1, graph, h_number_minus, 1, h_number_minus + 1, 1) * beta(h_number_minus + 1, graph)
    return get_probability(1, graph, h_number_minus + 1, 1, h_number_minus + 1, 2) * get_probability(1, graph, h_number_minus, 1, h_number_minus + 1, 1) * beta(h_number_minus + 1, graph)
...
while converge == False:
    ...
    summation_alpha = 0
    summation_beta = 0
    alpha(1, hidden_markov_network)
    beta(1, hidden_markov_network)
    ...
    for x in range(0, T):
        for y in range(0, T):
            ...
            numerator = summation_alpha * get_probability(1, hidden_markov_network, i_dash, 1, i_dash, 2) * get_probability(1, hidden_markov_network, i, 1, i_dash, 1) * summation_beta
            ...
            for r in range(T):
                ...
                i_dash = r + 1
                beta(i_dash, hidden_markov_network)
                denominator = denominator + summation_alpha * get_probability(1, hidden_markov_network, i_dash, 1, i_dash, 2) * get_probability(1, hidden_markov_network, i, 1, i_dash, 1) * summation_beta
